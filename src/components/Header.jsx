...
const Header = () => {
  return (
    <header
      // style={{
      //   backgroundImage: `url(${'https://images.unsplash.com/photo-1519750783826-e2420f4d687f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80'})`,
      // }}
      className="bg-base min-h-1/2"
    >
        ...
        <div className=" flex flex-col justify-between items-center md:flex-row py-20 relative gap-y-14">
          <div className="md:text-left text-center text-text">
            ...
            <div className="flex flex-col gap-2 py-6 text-sm text-text">
              <div className="flex flex-row items-center gap-2 md:justify-start justify-center hover:text-white">
